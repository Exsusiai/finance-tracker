...
| # | Task | Notion ID | 状态 |
|---|------|-----------|------|
| 1 | 导航重构 + 页面合并 | `3544d644-6869-81ea-b4aa-c67f336ba17d` | ⏳ 执行中 |
| 2 | 资产管理页面 - 完整 CRUD | `3544d644-6869-8178-9403-e0e51cbd4612` | Not started |
| 3 | 总览页重构 - 去重 + 资产概览 | `3544d644-6869-815a-bd87-d1426c0dbd08` | Not started |
