...
| 12 | 资产搜索与自动识别 - 市场数据映射 | `3554d644-6869-81bf-94fd-dafa88cf835f` | ✅ Done |

### P1 — 功能增强
| # | Task | Notion ID | 状态 |
|---|------|-----------|------|
| 4 | 设置页面 - 账户与分类管理 | `3544d644-6869-81be-8115-c52acd892e7e` | ✅ Done |
| 5 | 市场数据 - 定时刷新 + 测试 | `3544d644-6869-8125-807d-c335240ad842` | ✅ Done |
| 6 | PDF 解析引擎 - 测试与修复 | `3544d644-6869-81de-b4f3-d83bcd21092b` | ✅ Done |
| 7 | 智能分类 - LLM Fallback | `3544d644-6869-81de-9898-d46704f34dc5` | ⏸️ 等待许可 |
| 13 | GoCardless 银行同步 - N26 + Revolut | `3554d644-6869-81bc-9357-db8f975d171e` | ⏳ 等待许可 |
| 14 | Amex/Advanzia PDF 导入适配 | `3554d644-6869-81e8-bda8-cf813b648e92` | ⏳ 等待许可 |
